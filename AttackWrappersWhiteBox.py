...
def FGSMNativePytorch(device, dataLoader, model, epsilonMax, clipMin, clipMax):
    ...
    advLoader = utils.TensorToDataLoader(xAdv, yClean, transforms= None, batchSize= dataLoader.batch_size, randomizer=None) #use the same batch size as the original loader
    return advLoader
